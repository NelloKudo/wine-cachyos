...
NTSTATUS WINAPI unixcall_compat_wine_nt_to_unix_file_name( void *args )
{
    struct compat_wine_nt_to_unix_file_name_params *p = args;
    const OBJECT_ATTRIBUTES *attr = p->attr;
    char *nameA = p->nameA;
    ULONG *size = p->size;
    UINT disposition = p->disposition;
